                  ...
                  <div class="col-md-8">
                      ...
                      <?php
                        if (isset($_POST['searchbtn'])) {
                            ...
                            $countsearch = mysqli_num_rows($all_posts);
                            if ($countsearch == 0) { ?>
                      ...
                      <?php }
                        ...
                        elseif (isset($_GET['seartag'])) {
                            $seartag = $_GET['seartag'];
                            $tagsql = "SELECT * FROM post WHERE title LIKE '%$seartag%' OR description LIKE '%$seartag%' ORDER BY post_id DESC";
                            $all_pos = mysqli_query($conn, $tagsql);
                            $countsearch = mysqli_num_rows($all_pos);
                            if ($countsearch == 0) { ?>
                              <h3>Search Result For-><strong><?php echo "$seartag"; ?></strong> -Total Found-<?php echo "$countsearch"; ?> </h3>
                              <div class="alert alert-warning">No Result Found</div>
                              <?php } else {
                                while ($row = mysqli_fetch_assoc($all_pos)) {
                                    $post_id = $row['post_id'];
                                    $title = $row['title'];
                                    $description = $row['description'];
                                    $image = $row['image'];
